...
{
    public partial class XnorInfo : UserControl
    {
        public XnorInfo()
        {
            InitializeComponent();
        ...
        private void SetupCustomContent(ref MyList<Label> texts)
        {
            ...
            {
                Text = "XNOR Gate is TRUE (1) when both the inputs are the same, otherwise the XNOR gate is FALSE (0). It is equivalent to adding a NOT gate to the output of an XOR gate.",
            ...
            {
                Image = Image.FromFile("R/XNORInfo.png"),
            ...
            {
                Text = "The boolean algebra notation for a XNOR gate is '¬(⊕)'. For example:" +
            "\n\n ¬(A⊕B)",
                Font = new Font("Segoe UI", 10),
                Dock = DockStyle.Top,
                Padding = new Padding(12),
