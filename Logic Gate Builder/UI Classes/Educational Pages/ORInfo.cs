...
{
    public partial class ORInfo : UserControl
    {
        public ORInfo()
        {
            InitializeComponent();
        ...
        private void SetupCustomContent(ref MyList<Label> texts)
        {
            ...
            {
                Text = "An OR gate is TRUE (1) when either of its inputs are TRUE (1) and FALSE (0) if otherwise.",
            ...
            {
                Image = Image.FromFile("R/ORInfo.png"),
            ...
            {
                Text = "The boolean algebra notation for an OR gate is '+'. For example:" +
             "\n\n A+B",
                Font = new Font("Segoe UI", 10),
                Dock = DockStyle.Top,
                Padding = new Padding(12),
