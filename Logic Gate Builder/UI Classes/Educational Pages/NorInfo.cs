...
{
    public partial class NorInfo : UserControl
    {
        public NorInfo()
        {
            InitializeComponent();
        ...
        private void SetupCustomContent(ref MyList<Label> texts)
        {
            ...
            {
                Text = "An NOR gate is TRUE (1) when both of its inputs are FALSE (0) and FALSE (0) if otherwise. Similar to the NAND Gate, this gate is equivalent to adding a NOT gate to the output of an OR gate.",
            ...
            {
                Image = Image.FromFile("R/NORInfo.png"),
            ...
            {
                Text = "The boolean algebra notation for a NOR gate is '¬(+)'. For example:" +
             "\n\n ¬(A+B)",
                Font = new Font("Segoe UI", 10),
                Dock = DockStyle.Top,
                Padding = new Padding(12),
